  ...
  await t.test(
    ...
    async function () {
      ...
      assert.deepEqual(result.messages.map(String), [
        ...
        '169:3-169:15: Unexpected computed name of property, expected static name',
        '175:3-177:4: Unexpected static block, use static properties',
        '223:3-223:19: Unexpected computed name of method, expected static name',
        '253:3-255:4: Unexpected missing description for function or call',
        '253:3-255:4: Unexpected missing description for return value of function or call',
        '264:1-276:2: Unexpected missing description on class `Example`',
        '265:3-267:4: Unexpected missing description on get accessor `a`',
        '269:3-269:18: Unexpected missing description on set accessor `a`',
        '271:3-273:4: Unexpected missing description for function or call',
        '271:3-273:4: Unexpected missing description for return value of function or call',
        '275:3-275:21: Unexpected missing description for property `undocumented`',
        '298:14-298:36: Unexpected missing description for variable `implicitType`',
        '315:3-315:19: Unexpected computed name of property, expected static name',
        '335:3-335:17: Unexpected spread, use explicit exports',
        '351:3-351:24: Unexpected missing description for property `undocumentedShorthand`',
        '353:3-353:18: Unexpected missing description for property `undocumented`'
      ])
      const actual = serialize(await defaultFormat(result.symbols))
