  ...
  await t.test(
    ...
    async function () {
      ...
      assert.deepEqual(result.messages.map(String), [
        ...
        '100:37-137:2: Unexpected missing description on class `NamedClassExpression`',
        '124:17-124:21: Unexpected missing description for property `a`',
        '142:41-147:2: Unexpected missing description on class `AnonymousClassExpression`',
        '152:4-153:4: Unexpected missing description on `@param` for parameter `_`',
        '155:32-155:48: Unexpected missing description for function or call',
        '155:32-155:48: Unexpected missing description for return value of function or call',
        '171:3-171:15: Unexpected computed name of property, expected static name',
        '178:3-180:4: Unexpected static block, use static properties',
        '226:3-226:19: Unexpected computed name of method, expected static name',
        '256:3-258:4: Unexpected missing description for function or call',
        '256:3-258:4: Unexpected missing description for return value of function or call',
        '267:1-279:2: Unexpected missing description on class `Example`',
        '268:3-270:4: Unexpected missing description on get accessor `a`',
        '272:3-272:18: Unexpected missing description on set accessor `a`',
        '274:3-276:4: Unexpected missing description for function or call',
        '274:3-276:4: Unexpected missing description for return value of function or call',
        '278:3-278:21: Unexpected missing description for property `undocumented`',
        '301:14-301:36: Unexpected missing description for variable `implicitType`',
        '318:3-318:19: Unexpected computed name of property, expected static name',
        '338:3-338:17: Unexpected spread, use explicit exports',
        '354:3-354:24: Unexpected missing description for property `undocumentedShorthand`',
        '356:3-356:18: Unexpected missing description for property `undocumented`'
      ])
      const actual = serialize(await defaultFormat(result.symbols))
